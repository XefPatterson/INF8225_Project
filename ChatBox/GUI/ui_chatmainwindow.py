...
class Ui_ChatMainWindow(object):
    ...
    def setupUi(self, ChatMainWindow):
        ...
        self.chatHistory.setToolTip(QtGui.QApplication.translate("ChatMainWindow", "Messages sent and received", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.sendButton.setToolTip(QtGui.QApplication.translate("ChatMainWindow", "Sends a message", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.menuHelp.setTitle(QtGui.QApplication.translate("ChatMainWindow", "Help", None, QtGui.QApplication.UnicodeUTF8))
