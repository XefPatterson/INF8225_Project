...
class Seq2Seq(object):
    def __init__(self,
        ...
        self.max_encoder_sequence_length = 40
        self.batch_size = 12
        self.encoder_inputs = tf.placeholder(tf.int32, shape=[self.batch_size, self.max_encoder_sequence_length],
                                             name="encoder")
        self.decoder_inputs = [tf.placeholder(tf.int32, shape=[self.batch_size],
                                              name="decoder{}".format(i)) for i in range(self.max_encoder_sequence_length + 1)]
